...
macro(GET_CEF_URL)
  set ( CEF_BRANCH_TAG 2623 )
  set ( CEF_CHROME_VER 49.0.2623.110 )
  set ( CEF_VER 3.2623.1399 )
  set ( CEF_GIT_TAG g64e2fe1 )

  if ( OS_WINDOWS )
    # Windows
    set ( CEF_VER 3.2623.1401 )
    set ( CEF_GIT_TAG gb90a3be )
    if ( CMAKE_SIZEOF_VOID_P EQUAL 8 )
        # Windows 64bit
        set ( CEF_ARCH win64 )
        set ( CEF_ARCH_LONG windows64 )
    else ()
        # Windows 32bit
        set ( CEF_ARCH win )
        set ( CEF_ARCH_LONG windows32 )
    endif ()
  elseif ( OS_MACOSX )
    # OSX 64-bit
    set ( CEF_ARCH mac64 )
    set ( CEF_ARCH_LONG macosx64 )
  elseif ( OS_LINUX )
    # Linux 64-bit
    set ( CEF_ARCH linux64 )
    set ( CEF_ARCH_LONG linux64 )
  else ()
